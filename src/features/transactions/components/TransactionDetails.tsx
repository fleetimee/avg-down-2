import { AlertCircle, PencilIcon, CheckSquareIcon, ShareIcon } from "lucide-react";
...
export function TransactionDetails({ transaction, coinDetails }: TransactionDetailsProps) {
  return (
    <Card variant="white">
      ...
      <CardContent className="grid gap-4">
        ...
        <div className="grid gap-4 pt-4">
          ...
          <div className="flex justify-between py-2 border-b">
            <span className="text-muted-foreground font-mono text-sm">Price per coin</span>
            <span className="font-mono text-sm">
